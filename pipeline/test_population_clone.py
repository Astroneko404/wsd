...
if __name__ == '__main__':
    ...
    dataset_processed_path = data_path + "/mimic_cluster_k20_s10/processed"
    abbr_inventory_path = data_path + "/abbr_inventory.pkl"
    example_note_path = "/data/batch4/500K_By_Sources_2013_output/PEGREMO_21/doc.9071.txt"
    ...
    wsd = AbbrDisambiguation2(
        train_processed_path=dataset_paths.mimic_clus_k20_s10_train_folder,
    ...
    with open("./result_mimic_k20_s10_{0}.pkl".format(abbr), "wb") as result_file:
