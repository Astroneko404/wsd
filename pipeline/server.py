...
if __name__ == '__main__':
    ...
    wsd = AbbrDisambiguation(
        ...
        train_processed_path=dataset_paths.upmc_ag_train_folder,
    ...
    def wsd_single_text():
        ...
        # texts = ["""mouth daily Magnesium Oxide-Mg AA Chelate ( MAGNESIUM ) 300
        # """]
        result = [r for (_,r) in sorted(wsd.process_texts(texts).items(),key=lambda x:int(x[0]))]
